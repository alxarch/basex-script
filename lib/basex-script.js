/*
 * basex-script
 * https://github.com/alxarch/basex-script
 *
...
Script.prototype = {
	...
	log: function(msg){
		return this.xquery(format('db:output("%s&#10;")', msg));
	},
	createdb: function (dbname, input) {
		return this.command('create-db', input, {name: dbname});
	},
	optimize: function(all){
		return this.command(all ? 'optimize-all' : 'optimize');
	},
